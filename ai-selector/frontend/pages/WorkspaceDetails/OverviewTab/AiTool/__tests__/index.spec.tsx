...
jest.mock('@/plugins/ai-selector/pages/WorkspaceDetails/OverviewTab/AiTool/InfoModal', () => ({
  AiToolInfoModal: () => <div data-testid="ai-tool-info-modal" />,
}));

jest.mock('@/plugins/ai-selector/pages/WorkspaceDetails/OverviewTab/AiTool/SelectorModal', () => ({
